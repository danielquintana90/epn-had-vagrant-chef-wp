...
- También debes instalar las gemas `serverspec` y `kitchen-vagrant` para poder ejecutar las pruebas de integración e infraestructura:
...
```
Si usas Windows, y tienes un error al ejectuar las pruebas de integración e infraestructura respecto a este código del archivo **tests.ps1**,
...
```
instala Chef Workstation desde este enlace: https://community.chef.io/downloads/tools/workstation?os=windows

Para validar que se instaló correctamente, ejecuta el siguiente comando:
